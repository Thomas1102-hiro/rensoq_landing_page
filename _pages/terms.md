...
この利用規約（以下，「本規約」といいます。）は，高校化学ChemQuiz制作チーム（以下，「当社」といいます。）がモバイルデバイスで提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
